package org.yourcompany.scaler.mfweveningjune26.multithreading.sum1marray;
...
public class Client {
  public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 1_000_000; i++) { // 100000
        ...
        executor.shutdown(); // VERY VERY IMPORTANT>
    }
}